...
namespace ELogic\CurrencyRates\Helper;



use ELogic\CurrencyRates\Api\CurrencyRateReposytoryInterface;
use ELogic\CurrencyRates\Model\CurrencyRate;
...
class Data extends AbstractHelper
{
    ...
    public function __construct(
        ...
        CurrencyRateReposytoryInterface $repository,
    ...
    public function getFirstPriceRate(string $currency, string $baseCurrency = self::BASE_CURRENCY)
    {
        ...
        try {
            $result = $this->currencyRateRepositoryg->getList($searchCriteria);
